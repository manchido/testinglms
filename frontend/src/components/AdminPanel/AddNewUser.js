...
import { Col, Button, Modal, ModalFooter, Form, FormGroup, Label, Input, ModalHeader, ModalBody } from "reactstrap"
...
export default (props) => {
  ...
  return (
    <span>
      {addNew && < Modal isOpen={true} fullscreen="xl" style={{ display: 'block', maxWidth: 800 }}    modalTransition={{ timeout: 2000 }}>
      ...
      <Form onSubmit={(e) => handleLogin(e)} >
        <ModalBody>
          ...
          <FormGroup check inline >
            <Input type="checkbox" name='userManagement' id='userManagement' trueValue="yes" falseValue="no" 
            />
            <Label check>
              User Management
            </Label>
          ...
          <FormGroup check inline >
            <Input type="checkbox" name='courseManagement' id='courseManagement' trueValue="yes" falseValue="no"  />
            <Label check>
              Course Management
            </Label>
          </FormGroup>
          ...
          <FormGroup check inline >
            <Input type="checkbox" name='studentManagement' id='studentManagement' trueValue="yes" falseValue="no"  />
            <Label check>
              Student Management
            </Label>
          </FormGroup>
